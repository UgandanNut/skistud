...
//
// var record1 = document.getElementById("rec1");
// var record2 = document.getElementById("rec2");

// record1.style.display = "none";
...
// function T1click() {
//   var pick1 = document.getElementById("T1");
//   var pick2 = document.getElementById("T2");
//   var aud1 = document.getElementById("aud1");

//   record2.style.display = "none";
//   record1.style.display = "block";
...
let audio1 = new Audio("./assets/audio/track_1.mp3");
let audio2 = new Audio("./assets/audio/track_2.mp3");
let audio3 = new Audio("./assets/audio/track_3.mp3");
