    ...
    return (
      ...
      this.each(function () {
        ...
        "background" === v
          ...
          : "foreground" === v &&
            ("vertical" === w ? e.vertical(k, z, u, t) : "horizontal" === w && e.horizontal(k, z, u, t)),
          ...
          a(window).on("load scroll", function () {
            ...
            c || (window.requestAnimationFrame(d), (c = !0)),
              "background" === v
                ...
                : "foreground" === v &&
                  g <= j &&
                  ("vertical" === w ? e.vertical(k, q, u, t) : "horizontal" === w && e.horizontal(k, q, u, t));
          });
      })
    );
  };
    ...
    return this.each(function () {
      ...
      function s(e) {
        ...
        0 > h && (h += 360),
          ...
          a.css(
            "background",
            "linear-gradient(" + h + "deg, rgba(255,255,255," + (e.offsetY / s) * 0.5 + ") 0%,rgba(255,255,255,0) 80%)"
          );
      }
      function n() {
  ...
  e.scrollIt = function (t) {
    ...
    var o = function (t) {
      ...
      var r =
        ...
        (e("[data-scroll-index=" + t + "]").offset().top ? e(".parallax__layer").offset().top * -4 : 0) +
        n.topOffset +
        0;
      e("#home").animate({ scrollTop: r, easing: n.easing }, n.scrollTime);
    };
    var u = function (t) {
      var n =
